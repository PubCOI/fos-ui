...
export const Home = () => {
    return (
        <>
            ...
            <Row>
                <Col md={"10"} className={"offset-md-1 p-5 my-5 shadow rounded"}>
                    <div className={"display-4"}>Fos</div>
                    <div className={"lead"}>
                        Find and investigate links between public contracts, companies, officers and politicians<span className={"text-muted text-superscript"}>*</span>
                    </div>
                    <div className={"small text-muted"}><span className={"text-superscript"}>*</span>work (very much) in progress</div>
                </Col>
            </Row>


            <Row>
                <Col md={"10"} className={"offset-md-1 shadow p-5 rounded"}>
                    <p>
